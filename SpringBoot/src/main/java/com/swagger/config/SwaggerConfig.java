...
//通过浏览器抓包就可以看到
//它是通过类似于http://localhost:8080/v2/api-docs?group=sysGroup  http://localhost:8080/swagger-ui.html
...
public class SwaggerConfig {
    ...
    public Docket createRestApi(){
        return new Docket(DocumentationType.SWAGGER_2)
                .groupName("apiGroup1").apiInfo(apiInfo()) //组名
    ...
    private ApiInfo apiInfo(){
        return new ApiInfoBuilder()
                ...
                .contact(new Contact("肖晓翔","http://baidu.com","190899887@qq.com"))//创建人
                .version("1.0")  //版本号
                .description("Api 描述")
                .build();
    }
